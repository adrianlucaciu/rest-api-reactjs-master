...
class Book extends Component {
  ...
  findBookById = (bookId) => {
    ...
    setTimeout(() => {
      let lines = this.props.bookObject.lines;
      if (lines != null) {
        this.setState({
          id: lines.id,
          title: lines.title,
          author: lines.author,
          coverPhotoURL: lines.coverPhotoURL,
          isbnNumber: lines.isbnNumber,
          price: lines.price,
  ...
  submitBook = (event) => {
    ...
    this.props.saveBook(lines);
    setTimeout(() => {
      if (this.props.bookObject.lines != null) {
...
const mapStateToProps = (state) => {
  return {
    bookObject: state.lines,
  };
};

const mapDispatchToProps = (dispatch) => {
  return {
    saveBook: (lines) => dispatch(saveBook(lines)),
    fetchBook: (bookId) => dispatch(fetchBook(bookId)),
    updateBook: (lines) => dispatch(updateBook(lines)),
