	...
	public void run(String... args) throws Exception {
		...
		if (bookService.findAll().isEmpty()) {
			for (int i = 1; i <= 1000; i++) {
				...
				lines.setLineNumber("Spring Microservices in Action " + i);
				lines.setFirstStation("John Carnell " + i);
				lines.setFinalStation(
						"https://images-na.ssl-images-amazon.com/images/I/417zLTa1uqL._SX397_BO1,204,203,200_.jpg");
				lines.setIsbnNumber(1617293989L);
				lines.setStations(2776.00 + i);
				lines.setLanguage("English");
				lines.setGenre("Technology");
				bookService.saveOrUpdate(lines);
			}
		}
	}
